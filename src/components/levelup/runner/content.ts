...
export const PLAYABLE_RUNNERS: RunnerCharacter[] = [
  {
    ...
    color: "#FF0000",
    assets: {
      cutout: "/runners/tcl/cutout.png",
      hud: "/runners/tcl/hud.png",
      avatar: "/runners/tcl/avatar.png"
    },
    fullCard: "/runners/tcl/full-card.png",
    stats: { power: 8, speed: 6, defense: 8, utility: 7 },
    abilities: [
      { slot: 1, label: "Equalizer Blast", description: "Wide area shockwave.", path: "/runners/tcl/abilities/blast.png" },
      { slot: 2, label: "Power Smash", description: "Heavy strike.", path: "/runners/tcl/abilities/smash.png" },
      { slot: 3, label: "NXTV Core", description: "Instant 20% battery.", path: "/runners/tcl/abilities/core.png" }
    ]
  },
  {
    id: "pixel",
    ...
    color: "#00FF00",
    assets: {
      cutout: "/runners/pixel/cutout.png",
      hud: "/runners/pixel/hud.png",
      avatar: "/runners/pixel/avatar.png"
    },
    fullCard: "/runners/pixel/full-card.png",
    stats: { power: 6, speed: 9, defense: 5, utility: 10 },
    abilities: [
      { slot: 1, label: "Data Swarm", description: "Hacks nearby obstacles.", path: "/runners/pixel/abilities/blast.png" },
      { slot: 2, label: "Pixel Laser", description: "Precision piercing beam.", path: "/runners/pixel/abilities/smash.png" },
      { slot: 3, label: "Adaptive Protocol", description: "Invulnerability for 3s.", path: "/runners/pixel/abilities/core.png" }
    ]
  },
  {
    id: "apple",
    ...
    color: "#66B2FF",
    assets: {
      cutout: "/runners/apple/cutout.png",
      hud: "/runners/apple/hud.png",
      avatar: "/runners/apple/avatar.png"
    },
    fullCard: "/runners/apple/full-card.png",
    stats: { power: 7, speed: 9, defense: 8, utility: 10 },
    abilities: [
      { slot: 1, label: "MagSafe Core", description: "Pulls nearby rewards.", path: "/runners/apple/abilities/blast.png" },
      { slot: 2, label: "Titanium Smash", description: "Precision lane strike.", path: "/runners/apple/abilities/smash.png" },
      { slot: 3, label: "Core Overdrive", description: "Short speed burst.", path: "/runners/apple/abilities/core.png" }
    ]
  },
  {
    id: "samsung",
    name: "Samsung Warrior",
    role: "Versatile Controller",
    trait: "Adaptive Defense & Multi-Lens Reads",
    color: "#9B5CFF",
    assets: {
      cutout: "/runners/samsung/cutout.png",
      hud: "/runners/samsung/hud.png",
      avatar: "/runners/samsung/avatar.png"
    },
    fullCard: "/runners/samsung/full-card.png",
    stats: { power: 10, speed: 8, defense: 8, utility: 10 },
    abilities: [
      { slot: 1, label: "Lens Burst", description: "Wide lens pulse.", path: "/runners/samsung/abilities/smash.png" },
      { slot: 2, label: "Precision Spear", description: "Pierces the safest route.", path: "/runners/samsung/abilities/blast.png" },
      { slot: 3, label: "Multi-Lens Mode", description: "Scans danger ahead.", path: "/runners/samsung/abilities/core.png" }
    ]
  },
  {
    id: "motorola",
    name: "Motorola Striker",
    role: "Speed Runner",
    trait: "Momentum Dashes & Fast Recovery",
    color: "#FF7A18",
    assets: {
      cutout: "/runners/motorola/cutout.png",
      hud: "/runners/motorola/hud.png",
      avatar: "/runners/motorola/avatar.png"
    },
    fullCard: "/runners/motorola/full-card.png",
    stats: { power: 7, speed: 10, defense: 6, utility: 8 },
    abilities: [
      { slot: 1, label: "Speed Dash", description: "Bursts through trouble.", path: "/runners/motorola/abilities/blast.png" },
      { slot: 2, label: "Vortex Slash", description: "Fast cutting strike.", path: "/runners/motorola/abilities/smash.png" },
      { slot: 3, label: "Adrenaline Boost", description: "Refills momentum.", path: "/runners/motorola/abilities/core.png" }
    ]
  },
];
...
export const CHARACTERS: CharacterDefinition[] = [
  {
    ...
    title: 'Charges on the move. Perfect parry reflects damage.',
    role: 'Precision Duelist',
    traitDescription: 'Premium titanium + midnight blue palette. Strong glow accents for readability.',
    rarity: 'Legendary',
    tagline: 'Clean. Precise. Unstoppable.',
    lore: 'A surgical striker built from premium device DNA. Focused on speed and agility.',
    accent: '#0B0F14',
    secondary: '#1A2230',
    armor: '#A6B0BE',
    icon: '◌',
    ...
    assets: {
      ...
      hudPortrait: '/assets/factions/apple/hud_portrait.png',
      avatar: '/assets/factions/apple/avatar_small.png',
      abilityIcons: [
        {
          slot: 'blast',
          label: 'MagSafe Core',
          path: '/assets/factions/apple/abilities/blast.svg',
          description: 'Magnetically pulls in nearby power-ups and boosts speed.',
        },
        {
          slot: 'smash',
          label: 'Titanium Smash',
          path: '/assets/factions/apple/abilities/smash.svg',
          description: 'Precision slash that cuts through anything in its path.',
        },
        {
          slot: 'core',
          label: 'Core Overdrive',
          path: '/assets/factions/apple/abilities/core.svg',
          description: 'Unleash a burst of speed and become unstoppable for a short time.',
        },
      ],
    },
    signature: 'MagSafe core, titanium armor, midnight blue palette.',
    passiveName: 'Perfect Parry',
    passiveDescription: 'Clean-hit reflection window with bonus score on near-miss timing.',
    abilityName: 'MagSafe Core',
    abilityDescription: 'Magnetically pulls in nearby power-ups and boosts speed.',
    ...
    abilities: [
      {
        ...
        name: 'Perfect Parry',
        type: 'passive',
        description: 'Reflects obstacles and damage when timed perfectly.',
        gameplayEffect: 'Clean-hit reflection window with bonus score.',
      },
      {
        id: 'magsafe_core',
        name: 'MagSafe Core',
      ...
      },
      {
        ...
        name: 'Core Overdrive',
        type: 'ultimate',
        description: 'Unleash a burst of speed and become unstoppable.',
        gameplayEffect: 'Extended speed and invincibility.',
      },
    ],
    flavor: 'Premium tech aesthetic. High agility focused.',
    stats: { speed: 9, agility: 10, power: 7, durability: 8 },
    nativeStats: { power: 7, speed: 9, defense: 8, utility: 10, max: 10, agility: 10, durability: 8 },
    gameplay: {
  ...
  },
  {
    ...
    title: 'Pushing boundaries with advanced tech.',
    role: 'Versatile Warrior',
    traitDescription: 'Triple lens system provide unmatched versatility on any battlefield.',
    rarity: 'Legendary',
    tagline: 'Futuristic, adaptable, versatile feel.',
    lore: 'A high-precision warrior that transforms and evolves to stay ahead.',
    accent: '#473C66',
    secondary: '#9B5CFF',
    armor: '#D7C2FF',
    icon: '◭',
    ...
    assets: {
      ...
      hudPortrait: '/assets/factions/samsung/hud_portrait.png',
      avatar: '/assets/factions/samsung/avatar_small.png',
      abilityIcons: [
        {
          slot: 'smash',
          label: 'Lens Burst',
          path: '/assets/factions/samsung/abilities/smash.svg',
          description: 'Fires an energy blast from all three lenses, damaging enemies in a wide area.',
        },
        {
          slot: 'blast',
          label: 'Precision Spear',
          path: '/assets/factions/samsung/abilities/blast.svg',
          description: 'Zooms in and fires a high-precision shot that pierces through targets.',
        },
        {
          slot: 'core',
          label: 'Multi-Lens Mode',
          path: '/assets/factions/samsung/abilities/core.svg',
          description: 'Activates all lenses to scan, predict, and create a protective energy field.',
        },
      ],
    },
    signature: 'Triple lens system, glowing tech accents, sharp edges.',
    ...
    abilityDescription: 'Fires an energy blast from all three lenses.',
    ...
    abilities: [
      {
        ...
        type: 'passive',
        description: 'Advanced versatility in every scenario.',
        gameplayEffect: 'Dynamic stat adjustment based on lane density.',
      },
      {
        id: 'lens_burst',
        name: 'Lens Burst',
        type: 'active',
        description: 'Wide area energy blast from all three lenses.',
        gameplayEffect: 'Clears a large circular area around the runner.',
      },
      {
        id: 'precision_spear',
        name: 'Precision Spear',
        type: 'active',
        description: 'High-precision piercing shot.',
        gameplayEffect: 'Snipes powerful enemies or bosses from a distance.',
      },
      {
        id: 'multi_lens_mode',
        name: 'Multi-Lens Mode',
        type: 'ultimate',
        description: 'Protective field with predictive scans.',
        gameplayEffect: 'Scans for rewards while maintaining a shield.',
      },
    ],
    flavor: 'Innovation pushing boundaries.',
    stats: { speed: 8, agility: 10, power: 7, durability: 8, versatility: 10 },
    nativeStats: { power: 7, speed: 8, defense: 8, utility: 10, max: 10, agility: 10, durability: 8, versatility: 10 },
    gameplay: {
  ...
  },
  {
    ...
    role: 'Brawler (Tank / Area Control)',
    traitDescription: 'Clears obstacles, high durability, power uptime. Value-heavy scoring.',
    rarity: 'Epic',
    tagline: 'Tech display chest is signature element. Brawler (Tank / Area Control).',
    ...
    assets: {
      ...
      hudPortrait: '/assets/factions/tcl/hud_portrait.png',
      avatar: '/assets/factions/tcl/avatar_small.png',
      abilityIcons: [
        {
          slot: 'blast',
          label: 'Equalizer Blast',
          path: '/assets/factions/tcl/abilities/blast.svg',
          description: 'Wide area shockwave that clears the path.',
        },
        {
          slot: 'smash',
          label: 'Power Smash',
          path: '/assets/factions/tcl/abilities/smash.svg',
          description: 'Heavy punch that destroys obstacles.',
        },
        {
          slot: 'core',
          label: 'NXTV Core',
          path: '/assets/factions/tcl/abilities/core.svg',
          description: 'Overload power systems for a massive boost.',
        },
      ],
    },
    signature: 'Tech-display chest with NXTVISION audio visualizer.',
    passiveName: 'NXT Core',
    passiveDescription: 'Push forward, create space, power up, dominate.',
    abilityName: 'Equalizer Blast',
    abilityDescription: 'Wide area shockwave that clears the path.',
    ultimateName: 'NXTV Core',
    ultimateDescription: 'Overload power systems for a massive boost.',
    abilities: [
      {
        id: 'equalizer_blast',
        ...
        type: 'active',
        description: 'Wide area shockwave that clears the path.',
        gameplayEffect: 'Clears all obstacles in a forward cone.',
      },
      {
        id: 'power_smash',
        name: 'Power Smash',
        type: 'active',
        description: 'Heavy punch that destroys obstacles.',
        gameplayEffect: 'Destroys immediate barriers and grants short armor.',
      },
      {
        id: 'nxt_core',
        name: 'NXT Core',
        type: 'passive',
        description: 'High durability and power uptime.',
        gameplayEffect: 'Increased resistance to small hazards.',
      },
      {
        id: 'nxtv_overdrive',
        name: 'NXTV Core',
        type: 'ultimate',
        description: 'Overload power systems for a massive boost.',
        gameplayEffect: 'Big score conversion and invincibility.',
      },
    ],
    flavor: 'Heavy, durable silhouette. Consistent neon red + black palette.',
    stats: { speed: 6, agility: 5, power: 10, durability: 10, utility: 8 },
    nativeStats: { power: 10, speed: 6, defense: 10, utility: 8, max: 10, agility: 5, durability: 10 },
    gameplay: {
  ...
  },
  {
    ...
    series: 'Moto Series',
    name: 'Turbo Striker',
    title: 'Speed is your greatest weapon. Keep moving.',
    role: 'Turbo Striker',
    traitDescription: 'Built for speed. Strikes fast, evades faster. Momentum is everything.',
    rarity: 'Epic',
    tagline: 'Clean, aggressive silhouette.',
    lore: 'Motorola is engineered for speed, momentum, and unstoppable flow.',
    accent: '#FF7A18',
    secondary: '#36D9FF',
    armor: '#22363B',
    icon: '⌁',
    ...
    assets: {
      ...
      hudPortrait: '/assets/factions/motorola/hud_portrait.png',
      avatar: '/assets/factions/motorola/avatar_small.png',
      abilityIcons: [
        {
          slot: 'blast',
          label: 'Speed Dash',
          path: '/assets/factions/motorola/abilities/blast.svg',
          description: 'Dash forward at blinding speed. Breaks through obstacles.',
        },
        {
          slot: 'smash',
          label: 'Vortex Slash',
          path: '/assets/factions/motorola/abilities/smash.svg',
          description: 'Spin and slash in a high-speed vortex, hitting all enemies in range.',
        },
        {
          slot: 'core',
          label: 'Adrenaline Boost',
          path: '/assets/factions/motorola/abilities/core.svg',
          description: 'Overclock mobility. Increase movement speed and reduce ability cooldowns.',
        },
      ],
    },
    signature: 'Electric orange speed lines, razr hinge wings.',
    ...
    abilities: [
      {
        ...
        name: 'Turbo Core',
        type: 'passive',
        description: 'Strikes fast, evades faster. Momentum is everything.',
        gameplayEffect: 'Increased evasion window when at high speed.',
      },
      {
        id: 'speed_dash',
        name: 'Speed Dash',
        ...
        gameplayEffect: 'Burst speed opener that breaks obstacles.',
      },
      {
        id: 'vortex_slash',
        name: 'Vortex Slash',
        ...
        gameplayEffect: 'Circular clear with invulnerability frames.',
      },
      {
        id: 'adrenaline_boost',
    ...
    flavor: 'Futuristic racer/speedster vibe.',
    stats: { speed: 10, agility: 10, power: 7, durability: 6, mobility: 10 },
    nativeStats: { power: 7, speed: 10, defense: 6, utility: 8, max: 10, agility: 10, durability: 6, mobility: 10 },
    gameplay: {
  ...
  },
  {
    ...
    title: 'Enhances processing power to predict, adapt, and dominate.',
    role: 'Neural Sentinel',
    traitDescription: 'Clean, intelligent, high-tech aesthetic. Pixel / data motifs for identity.',
    rarity: 'Epic',
    tagline: 'Strong silhouette for readability.',
    lore: 'The Neural Sentinel uses advanced AI and data processing to predict enemy movements and control the flow of battle.',
    accent: '#9AE94A',
    secondary: '#34D399',
    armor: '#E8EDF6',
    icon: '◎',
    ...
    assets: {
      ...
      hudPortrait: '/assets/factions/pixel/hud_portrait.png',
      avatar: '/assets/factions/pixel/avatar_small.png',
      abilityIcons: [
        {
          slot: 'smash',
          label: 'Data Swarm',
          path: '/assets/factions/pixel/abilities/smash.svg',
          description: 'Deploys micro-drones that attack multiple enemies.',
        },
        {
          slot: 'blast',
          label: 'Pixel Laser',
          path: '/assets/factions/pixel/abilities/blast.svg',
          description: 'Locks on and fires a precision beam.',
        },
        {
          slot: 'core',
          label: 'Adaptive Protocol',
          path: '/assets/factions/pixel/abilities/core.svg',
          description: 'Analyzes the battlefield and boosts defenses.',
        },
      ],
    },
    signature: 'Neon green + white + dark gray palette. Floating drones.',
    ...
    abilities: [
      {
        id: 'digital_tactician',
        name: 'Digital Tactician',
        type: 'passive',
        description: 'Scans the battlefield and predicts enemy actions.',
        gameplayEffect: 'Visual path indicators for upcoming hazards.',
      },
      {
        id: 'data_swarm',
        name: 'Data Swarm',
        type: 'active',
        description: 'Deploys micro-drones that attack multiple enemies.',
        gameplayEffect: 'Automated hazard clearing in a forward area.',
      },
      {
        id: 'pixel_laser',
        name: 'Pixel Laser',
        type: 'active',
        description: 'Locks on and fires a precision beam.',
        gameplayEffect: 'Instant piercing strike through barriers.',
      },
      {
        id: 'adaptive_ai',
        name: 'Adaptive AI',
        type: 'ultimate',
        description: 'Adjusts abilities and systems to any situation instantly.',
        gameplayEffect: 'Dynamic ability cooldown reduction based on score.',
      },
    ],
    flavor: 'Outsmarts, outplays, and controls the outcome.',
    stats: { speed: 8, agility: 9, power: 7, durability: 7, intelligence: 10, adaptability: 10, defense: 7, utility: 9 },
    nativeStats: { power: 7, speed: 8, defense: 7, utility: 9, max: 10, agility: 9, durability: 7, intelligence: 10, adaptability: 10 },
    gameplay: {
  ...
  },
  {
    ...
    name: 'Kip',
    title: 'Knowledge strengthens the signal.',
    role: 'AI Operator & Guide',
    traitDescription: 'Confident, Curious, Supportive, Playful. Knowledge strengthens the signal.',
    rarity: 'Legendary',
    tagline: 'Always On. Always Ready.',
    lore: 'Kip is your AI operator and trusted sidekick. Always on, always ready to guide you through the digital grid.',
    accent: '#FF0066',
    secondary: '#FF40FF',
    armor: '#0F0F14',
    icon: '✦',
    ...
    assets: {
      cutout: '/kip/hero.png',
      hudPortrait: '/kip/mobile.png',
      avatar: '/kip/avatar.png',
      abilityIcons: [
        {
          slot: 'smash',
          label: 'Signal Check',
          path: '/kip/abilities/smash.png',
          description: 'Kip scans ahead, highlighting safe lanes and threats.',
        },
        {
          slot: 'blast',
          label: 'Bonus Round',
          path: '/kip/abilities/blast.png',
          description: 'Kip triggers a short bonus opportunity.',
        },
        {
          slot: 'core',
          label: 'KIP Challenge',
          path: '/kip/abilities/core.png',
          description: 'Optional risk/reward challenge for bonus rewards.',
        },
      ],
    },
    signature: 'Magenta + black brand identity. Expressive 2D head/orb.',
    supportOnly: true,
    passiveName: 'Always On',
    passiveDescription: 'Knowledge strengthens the signal.',
    abilityName: 'Signal Check',
    abilityDescription: 'Highlights the safest lane and pulls useful rewards closer.',
    ultimateName: 'Knowledge Signal',
    ultimateDescription: 'Amplifies the active runner with a massive knowledge boost.',
    abilities: [
      {
        id: 'always_on',
        name: 'Always On',
        type: 'passive',
        description: 'Knowledge strengthens the signal.',
      ...
      },
      {
        ...
        name: 'Signal Check',
        type: 'active',
        description: 'Scans ahead and highlights safe lanes.',
        gameplayEffect: 'Path reveal plus defensive highlights.',
      },
      {
        id: 'bonus_round',
        name: 'Bonus Round',
        type: 'active',
        description: 'Triggers a short bonus state.',
        gameplayEffect: 'Increased reward spawns for 5 seconds.',
      },
      {
        id: 'knowledge_signal',
        name: 'Knowledge Signal',
        type: 'ultimate',
        description: 'Massive knowledge boost projects a grid over the track.',
        gameplayEffect: 'Time slow, wide magnet, and boosted scoring.',
      },
    ],
    flavor: 'Always on. Always ready.',
    stats: { speed: 8, agility: 9, power: 6, durability: 9, utility: 10 },
    nativeStats: { power: 6, speed: 8, defense: 9, utility: 10, max: 10 },
    gameplay: {
...
export const RUNNER_BOSSES: BossDefinition[] = [
  {
    ...
    secondary: '#B7DCFF',
    emblem: '◍',
    stats: { power: 9, speed: 4, defense: 10, control: 9, disruption: 8 },
    assets: {
      banner: '/levelup/runner/bosses/atlas-backbone-banner.png',
      hudPortrait: '/levelup/runner/bosses/atlas-backbone-portrait.png',
      avatarSmall: '/levelup/runner/bosses/atlas-backbone-avatar.png',
    },
    mechanics: [
  ...
  },
  {
    ...
    secondary: '#FF8A8A',
    emblem: '✓',
    stats: { power: 10, speed: 6, defense: 10, control: 9, disruption: 8 },
    assets: {
      banner: '/levelup/runner/bosses/redline-commander-banner.png',
      hudPortrait: '/levelup/runner/bosses/redline-commander-portrait.png',
      avatarSmall: '/levelup/runner/bosses/redline-commander-avatar.png',
    },
  ...
  },
  {
    ...
    secondary: '#FF7A18',
    emblem: 'Ψ',
    stats: { power: 8, speed: 8, defense: 7, control: 9, disruption: 10 },
    assets: {
      banner: '/levelup/runner/bosses/patchwork-hydra-banner.png',
      hudPortrait: '/levelup/runner/bosses/patchwork-hydra-portrait.png',
      avatarSmall: '/levelup/runner/bosses/patchwork-hydra-avatar.png',
    },
  ...
  },
  {
    ...
    secondary: '#FF5CFF',
    emblem: '◉',
    stats: { power: 7, speed: 4, defense: 8, control: 9, disruption: 10 },
    assets: {
      banner: '/levelup/runner/bosses/throttle-maw-banner.png',
      hudPortrait: '/levelup/runner/bosses/throttle-maw-portrait.png',
      avatarSmall: '/levelup/runner/bosses/throttle-maw-avatar.png',
    },
  ...
  },
  {
    ...
    secondary: '#FF3FB7',
    emblem: '∅',
    stats: { power: 10, speed: 6, defense: 10, control: 10, disruption: 10 },
    assets: {
      banner: '/levelup/runner/bosses/dead-zone-titan-banner.png',
      hudPortrait: '/levelup/runner/bosses/dead-zone-titan-portrait.png',
      avatarSmall: '/levelup/runner/bosses/dead-zone-titan-avatar.png',
    },
    mechanics: [
  ...
  },
  {
    id: 'bell_sovereign',
    name: 'Bell Sovereign',
    title: 'Network Ascendant',
    threatLevel: 'FinalBoss',
    progressionEligible: true,
    faction: 'The Old Network Order',
    fantasy:
      'The ultimate manifestation of the old monopoly. Ancient, dominating, and relentless. It aims to reclaim the network through sheer force and control.',
    visualTheme:
      'Brass cathedral with bell-shaped lower body, ornate copper-and-rust mechanical detail, glowing magenta core eyes at the top, illuminated bell-mark sigil at the chest.',
    accent: '#C9A24A',
    secondary: '#E8C547',
    emblem: '⚜',
    stats: { power: 10, speed: 8, defense: 10, control: 10, disruption: 10 },
    assets: {
      banner: '/levelup/runner/bosses/bell-banner.png',
      hudPortrait: '/levelup/runner/bosses/bell-portrait.png',
      avatarSmall: '/levelup/runner/bosses/bell-avatar.png',
    },
    mechanics: [
      'Phase 1: Dormant Relay King - Heavy area suppression.',
      'Phase 2: Command Uplink - Targeted orbital strikes.',
      'Phase 3: Network Ascendant - Reality-warping grid shifts.',
      'Phase 4: Bell Sovereign Overload - Absolute noise flood.',
    ],
    counterplay: [
      'Coordinate with Kip for synchronized signal breaks',
      'Identify and strike the core sigil during overload',
      'Maintain peak performance to survive the noise flood',
    ],
    milestoneLevel: 6,
  },
];
...
const isProgressionBoss = (boss: BossDefinition) => boss.progressionEligible !== false && boss.threatLevel !== 'HiddenArchitect';
export const getBossForLevel = (level: number) => RUNNER_BOSSES.find((boss) => isProgressionBoss(boss) && boss.milestoneLevel === level) ?? null;
export const getBossForProgress = (level: number) =>
  RUNNER_BOSSES
    .filter((boss) => isProgressionBoss(boss) && boss.milestoneLevel <= level)
